def createpokemonlist(parent):
    ...
    pokemonlist = [
        Pokemon(
            ...
            skill=[["Silently judge", 0, 2, "Phys"]], name="Training dummy", parent=parent, elementlist=parent.pokemonlist,velocity=0.8
        ),
        ...
        Pokemon(
            ...
            passive=[Passive('Gold',"resourcemax",40,1)],velocity=0.8
        ),
        Pokemon(
            ...
            passive=[Passive('patk','addstats',1,1),Passive('pdef','addstats',1,1),
                     ...
                     Passive('hp','mulstats',0.5,1)],velocity=0.8
        ),
        Pokemon(
            ...
            passive=[Passive('Wood',"resourcemax",10,1),Passive('Wood',"resourceregen",1,1)
                     ...
                     Passive('Rest',"longimprove",1,1)],velocity=0.8
        ),
        Pokemon(
            ...
            drop={"exp": 3,
                  "resources": [["Cow hide", 1, 10], ["Beef", 1, 10], ["Strength gems", 1, 10], ["Magic gems", 1, 10],
                                ["Special gems", 1, 10]]},
            name="Cow", parent=parent, elementlist=parent.pokemonlist, skill=[["Rear kick", 5, 2, "Phys"]],velocity=0.8
        ),
        Pokemon(
            ...
            drop={"exp": 4, "resources": [["Snake skin", 1, 10], ["Strength gems", 1, 10], ["Magic gems", 1, 10],
                                          ["Special gems", 1, 10]]},
            name="Snake", parent=parent, elementlist=parent.pokemonlist, skill=[["Squeeze", 9, 2.8, "Phys"]],velocity=0.8
        ),
        Pokemon(
            1200, 150, 100, 200, 200, 30, 0, 30, 30, 30, 30,num=7,
            drop={"exp": 5, "resources": [["Strength gems", 1, 10], ["Magic gems", 1, 10], ["Special gems", 1, 10]]},
            name="Francesco", parent=parent, elementlist=parent.pokemonlist, skill=[["Azura blow", 13, 3.5, "Phys"]],velocity=0.8
        )
    ]
